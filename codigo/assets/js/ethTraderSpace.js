document.addEventListener('DOMContentLoaded', function() {
    ...
    const chart = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: 'Real-Time ETH/USD Trade Prices'
            }
        }
    });
    ...
    "subscribe_filter_symbol_id": ["BITSTAMP_SPOT_ETH_USD$", "BITFINEX_SPOT_ETH_LTC$"]
    }));
    };
...
const url = `https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_ETH_USD/history?apikey=${API_KEY}&period_id=1DAY&time_start=2021-01-01T00:00:00&limit=1095`;
